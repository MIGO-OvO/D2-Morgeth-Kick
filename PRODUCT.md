...
- The main window uses a custom title bar with familiar Windows minimize, maximize/restore, close, and drag behavior. It is resizable, reflows at content-driven breakpoints, and keeps every setting reachable through scrolling at compact sizes and high Windows display scaling.
